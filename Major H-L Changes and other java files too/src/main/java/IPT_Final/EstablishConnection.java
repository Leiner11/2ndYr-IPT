    ...
    if (isClicked==true) {
            try (ServerSocket listener = new ServerSocket(serverport)) {
                ...
                Con4TextField.setText("Using server socket: " + serverport);
                    ...
                    Con1TextField.setText("Port No.: " + clientSocket.getPort()); //GET PORT NO.

                    if(count<=5){
                        HistoryLogs HistoryLogs = new HistoryLogs(IP_Address,count);
                        //History.History(IP_Address,count);
...
// TODO add your handling code here:
    ...
    this.setVisible(false);
    new ManageNetwork(IP_Address,count).setVisible(true);// TODO add your handling code here:
    ...
    private void HistoryLogsButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_HistoryLogsButtonActionPerformed
        this.setVisible(false);
        new HistoryLogs(IP_Address,count).setVisible(true);        // TODO add your handling code here:
